...
use MacymedCacheBoost\Form\BotsType;
use MacymedCacheBoost\Services\ConfigurationService;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;

class AdminMacymedCacheBoostBotsController extends FrameworkBundleAdminController
{
    public function indexAction(Request $request): Response
    {
        $form = $this->createForm(BotsType::class, $this->get('macymedcacheboost.configuration.service')->getAllConfigValues());
        ...
        return $this->render('@Modules/macymedcacheboost/views/templates/admin/form.html.twig', [
            ...
            'layoutTitle' => $this->trans('Bots Settings', 'Modules.Macymedcacheboost.Admin'),
        ]);
    }
}